...
import 'profilecreator_model.dart';
export 'profilecreator_model.dart';

class ProfilecreatorWidget extends StatefulWidget {
  const ProfilecreatorWidget({super.key});

  @override
  State<ProfilecreatorWidget> createState() => _ProfilecreatorWidgetState();
}

class _ProfilecreatorWidgetState extends State<ProfilecreatorWidget> {
  late ProfilecreatorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfilecreatorModel());
